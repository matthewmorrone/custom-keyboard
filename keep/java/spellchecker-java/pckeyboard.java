...
public class PCKeyboard extends InputMethodService implements KeyboardView.OnKeyboardActionListener, SpellCheckerSession.SpellCheckerSessionListener {
  ...
  private static final float[] sNoneColorArray = {1.0f, 0, 0, 0, 0, // red
                                                  0, 1.0f, 0, 0, 0, // green
                                                  0, 0, 1.0f, 0, 0, // blue
                                                  0, 0, 0, 1.0f, 0 // alpha
  };

  private static final float[] sNegativeColorArray     = {-1.0f, 0, 0, 0, 255, // red
                                                          0, -1.0f, 0, 0, 255, // green
                                                          0, 0, -1.0f, 0, 255, // blue
                                                          0, 0, 0, 1.0f, 0 // alpha
  };
  private static final float[] sBlueBlackColorArray    = {-0.6f, 0, 0, 0, 41, // red
                                                          0, -0.6f, 0, 0, 128, // green
                                                          0, 0, -0.6f, 0, 185, // blue
                                                          0, 0, 0, 1.0f, 0 // alpha
  };
  private static final float[] sBlueWhiteColorArray    = {1.0f, 0, 0, 0, 41, // red
                                                          0, 1.0f, 0, 0, 128, // green
                                                          0, 0, 1.0f, 0, 185, // blue
                                                          0, 0, 0, 1.0f, 1 // alpha
  };
  private static final float[] sRedWhiteColorArray     = {1.0f, 0, 0, 0, 192, // red
                                                          0, 1.0f, 0, 0, 57, // green
                                                          0, 0, 1.0f, 0, 43, // blue
                                                          0, 0, 0, 1.0f, 0 // alpha
  };
  private static final float[] sRedBlackColorArray     = {-0.6f, 0, 0, 0, 192, // red
                                                          0, -0.6f, 0, 0, 57, // green
                                                          0, 0, -0.6f, 0, 43, // blue
                                                          0, 0, 0, 1.0f, 0 // alpha
  };
  private static final float[] sOrangeBlackColorArray  = {1.0f, 0, 0, 0, 230, // red
                                                          0, 1.0f, 0, 0, 126, // green
                                                          0, 0, 1.0f, 0, 34, // blue
                                                          0, 0, 0, 1.0f, 0 // alpha
  };
  private static final float[] sMaterialDarkColorArray = {1.0f, 0, 0, 0, 55, // red
                                                          0, 1.0f, 0, 0, 71, // green
                                                          0, 0, 1.0f, 0, 79, // blue
                                                          0, 0, 0, 1.0f, 1 // alpha
  };
  ...
  private int     standardKeyboardID = R.xml.futhark;
  private boolean isBoldCaps         = false;
  ...
  public void onInitializeInterface() {
    ...
    mStandardKeyboard = new LatinKeyboard(this, R.xml.futhark);
  ...
  public void swipeDown() {
    currentKeyboard.setRowNumber((short)(getRowNumber() - 1));
  }
  ...
  public void onRelease(int primaryCode) {
    ...
    //        getCurrentInputConnection().sendKeyEvent(new KeyEvent(100, 100, KeyEvent.ACTION_UP, getHardKeyCode(primaryCode), 0, KeyEvent.META_CTRL_ON | KeyEvent.META_ALT_ON));
  ...
  double S = primaryCode;
  double H = Math.floor((S - 0x10000) / 0x400) + 0xD800;
  double L = ((S - 0x10000) % 0x400) + 0xDC00;
  double N = ((H - 0xD800) * 0x400) + (L - 0xDC00) + 0x10000;

  String hex = Integer.toHexString(primaryCode).toUpperCase();
  int FirstAttempt  = Integer.parseInt(hex, 16);
  int SecondAttempt = Integer.decode("0x" + hex);

  // System.out.print("int: "); System.out.println(primaryCode);
  // System.out.print("hex: "); System.out.println(hex);
  // System.out.print("char: "); System.out.println(Character.toChars(primaryCode));
  // System.out.print("highSurrogate: "); System.out.println(Character.highSurrogate(primaryCode));
  // System.out.print("lowSurrogate: "); System.out.println(Character.lowSurrogate(primaryCode));

  try {
    byte[] utf8 = str.getBytes("UTF-8");
    byte[] utf16 = str.getBytes("UTF-16");
    String str8 = new String(utf8, "UTF-8");
    String str16 = new String(utf16, "UTF-16");
    System.out.print("str8: "); System.out.println(str8);
    System.out.print("str16: "); System.out.println(str16);
    System.out.printf("%x\r\n", str8.codePointAt(0));
    System.out.printf("%x\r\n", str16.codePointAt(0));
    System.out.printf("%x\r\n", str16.codePointAt(1));
  }
  ...
  private String getBold(int code) {
    switch(code) {
      case 120812: return "\uD835\uDFEC";
      case 120813: return "\uD835\uDFED";
      case 120814: return "\uD835\uDFEE";
      case 120815: return "\uD835\uDFEF";
      case 120816: return "\uD835\uDFF0";
      case 120817: return "\uD835\uDFF1";
      case 120818: return "\uD835\uDFF2";
      case 120819: return "\uD835\uDFF3";
      case 120820: return "\uD835\uDFF4";
      case 120821: return "\uD835\uDFF5";
      case 120275: return "\uD835\uDDD3";
      case 120276: return "\uD835\uDDD4";
      case 120277: return "\uD835\uDDD5";
      case 120278: return "\uD835\uDDD6";
      case 120279: return "\uD835\uDDD7";
      case 120280: return "\uD835\uDDD8";
      case 120281: return "\uD835\uDDD9";
      case 120282: return "\uD835\uDDDA";
      case 120283: return "\uD835\uDDDB";
      case 120284: return "\uD835\uDDDC";
      case 120285: return "\uD835\uDDDD";
      case 120286: return "\uD835\uDDDE";
      case 120287: return "\uD835\uDDDF";
      case 120288: return "\uD835\uDDE0";
      case 120289: return "\uD835\uDDE1";
      case 120290: return "\uD835\uDDE2";
      case 120291: return "\uD835\uDDE3";
      case 120292: return "\uD835\uDDE4";
      case 120293: return "\uD835\uDDE5";
      case 120294: return "\uD835\uDDE6";
      case 120295: return "\uD835\uDDE7";
      case 120296: return "\uD835\uDDE8";
      case 120297: return "\uD835\uDDE9";
      case 120298: return "\uD835\uDDEA";
      case 120299: return "\uD835\uDDEB";
      case 120300: return "\uD835\uDDEC";
      case 120301: return "\uD835\uDDED";
      case 120302: return "\uD835\uDDEE";
      case 120303: return "\uD835\uDDEF";
      case 120304: return "\uD835\uDDF0";
      case 120305: return "\uD835\uDDF1";
      case 120306: return "\uD835\uDDF2";
      case 120307: return "\uD835\uDDF3";
      case 120308: return "\uD835\uDDF4";
      case 120309: return "\uD835\uDDF5";
      case 120310: return "\uD835\uDDF6";
      case 120311: return "\uD835\uDDF7";
      case 120312: return "\uD835\uDDF8";
      case 120313: return "\uD835\uDDF9";
      case 120314: return "\uD835\uDDFA";
      case 120315: return "\uD835\uDDFB";
      case 120316: return "\uD835\uDDFC";
      case 120317: return "\uD835\uDDFD";
      case 120318: return "\uD835\uDDFE";
      case 120319: return "\uD835\uDDFF";
      case 120320: return "\uD835\uDE00";
      case 120321: return "\uD835\uDE01";
      case 120322: return "\uD835\uDE02";
      case 120323: return "\uD835\uDE03";
      case 120324: return "\uD835\uDE04";
      case 120325: return "\uD835\uDE05";
      case 120326: return "\uD835\uDE06";
      case 120327: return "\uD835\uDE07";
      case 120328: return "\uD835\uDE08";
    }
    return null;
  }
  ...
  public void onKey(int primaryCode, int[] keyCodes) {
    InputConnection ic = getCurrentInputConnection();
    System.out.println(primaryCode+" "+keyCodes[0]);

    if (primaryCode > 120000) {
      String ch = getBold(primaryCode);
      if (ch != null) {
        System.out.println(ch);
        getCurrentInputConnection().commitText(ch, 0);
      }
      return;
    }
    switch (primaryCode) {
      case -7:
        ...
        break;
      case -8:
        getCurrentInputConnection().setSelection(0, ((String)getCurrentInputConnection().getExtractedText(new ExtractedTextRequest(), 0).text).length());
        break;
      case -9:
      ...
      case Keyboard.KEYCODE_SHIFT:
        if (!isBoldCaps) {
          currentKeyboard = new LatinKeyboard(this, R.xml.bold_caps);
          kv.setKeyboard(currentKeyboard);
        }
        else {
          currentKeyboard = new LatinKeyboard(this, R.xml.qwerty);
