...
class Codes {
    ...
    private static int blockException(int primaryCode) {
        ...
        if (Variables.isCaps() && primaryCode ==   65) {return     65;}
        if (Variables.isCaps() && primaryCode ==   66) {return     66;}
        if (Variables.isCaps() && primaryCode ==   67) {return     67;}
        if (Variables.isCaps() && primaryCode ==   68) {return     68;}
        if (Variables.isCaps() && primaryCode ==   69) {return     69;}
        if (Variables.isCaps() && primaryCode ==   70) {return     70;}
        if (Variables.isCaps() && primaryCode ==   71) {return     71;}
        if (Variables.isCaps() && primaryCode ==   72) {return     72;}
        if (Variables.isCaps() && primaryCode ==   73) {return     73;}
        if (Variables.isCaps() && primaryCode ==   74) {return     74;}
        if (Variables.isCaps() && primaryCode ==   75) {return     75;}
        if (Variables.isCaps() && primaryCode ==   76) {return     76;}
        if (Variables.isCaps() && primaryCode ==   77) {return     77;}
        if (Variables.isCaps() && primaryCode ==   78) {return     78;}
        if (Variables.isCaps() && primaryCode ==   79) {return     79;}
        if (Variables.isCaps() && primaryCode ==   80) {return     80;}
        if (Variables.isCaps() && primaryCode ==   81) {return   1192;}
        if (Variables.isCaps() && primaryCode ==   82) {return     82;}
        if (Variables.isCaps() && primaryCode ==   83) {return     83;}
        if (Variables.isCaps() && primaryCode ==   84) {return     84;}
        if (Variables.isCaps() && primaryCode ==   85) {return     85;}
        if (Variables.isCaps() && primaryCode ==   86) {return     86;}
        if (Variables.isCaps() && primaryCode ==   87) {return     87;}
        if (Variables.isCaps() && primaryCode ==   88) {return     88;}
        if (Variables.isCaps() && primaryCode ==   89) {return     89;}
        if (Variables.isCaps() && primaryCode ==   90) {return     90;}
        if (Variables.isCaps() && primaryCode ==   97) {return   7424;}
        if (Variables.isCaps() && primaryCode ==   98) {return    665;}
        if (Variables.isCaps() && primaryCode ==   99) {return   7428;}
        if (Variables.isCaps() && primaryCode ==  100) {return   7429;}
        if (Variables.isCaps() && primaryCode ==  101) {return   7431;}
        if (Variables.isCaps() && primaryCode ==  102) {return  42800;}
        if (Variables.isCaps() && primaryCode ==  103) {return    610;}
        if (Variables.isCaps() && primaryCode ==  104) {return    668;}
        if (Variables.isCaps() && primaryCode ==  105) {return    618;}
        if (Variables.isCaps() && primaryCode ==  106) {return   7434;}
        if (Variables.isCaps() && primaryCode ==  107) {return   7435;}
        if (Variables.isCaps() && primaryCode ==  108) {return    671;}
        if (Variables.isCaps() && primaryCode ==  109) {return   7437;}
        if (Variables.isCaps() && primaryCode ==  110) {return    628;}
        if (Variables.isCaps() && primaryCode ==  111) {return   7439;}
        if (Variables.isCaps() && primaryCode ==  112) {return   7448;}
        if (Variables.isCaps() && primaryCode ==  113) {return   1193;}
        if (Variables.isCaps() && primaryCode ==  114) {return    640;}
        if (Variables.isCaps() && primaryCode ==  115) {return  42801;}
        if (Variables.isCaps() && primaryCode ==  116) {return   7451;}
        if (Variables.isCaps() && primaryCode ==  117) {return   7452;}
        if (Variables.isCaps() && primaryCode ==  118) {return   7456;}
        if (Variables.isCaps() && primaryCode ==  119) {return   7457;}
        if (Variables.isCaps() && primaryCode ==  120) {return    120;}
        if (Variables.isCaps() && primaryCode ==  121) {return    655;}
        if (Variables.isCaps() && primaryCode ==  122) {return   7458;}
