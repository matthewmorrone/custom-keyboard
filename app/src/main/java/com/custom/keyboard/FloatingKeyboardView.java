...
public class FloatingKeyboardView extends KeyboardView {
    ...
    public FloatingKeyboardView(Context context, AttributeSet attrs) {
        ...
        this.setOnTouchListener(mKeyboardOnTouchListener);
    ...
    public static boolean isAlignBottomCenter() {
        return alignBottomCenter;
    }

    public static void setAlignBottomCenter(boolean alignBottomCenter) {
        FloatingKeyboardView.alignBottomCenter = alignBottomCenter;
    }
    ...
    public void registerEditText(int resid) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {
                final Method method = EditText.class.getMethod("setShowSoftInputOnFocus", new Class[] {
                    boolean.class
                });
     ...
     */
    private OnTouchListener mKeyboardOnTouchListener = new OnTouchListener() {
        float dx;
        float dy;
        int moveToY;
        int moveToX;
    ...
    private Rect keepInScreen(int topMargin, int leftMargin) {
        ...
        if (top <= rootBounds.top) top = rootBounds.top;
        else if (top + height > rootBounds.bottom) top = rootBounds.bottom - height;

        if (left <= rootBounds.left) left = rootBounds.left;
        else if (left + width > rootBounds.right) left = rootBounds.right - width;
    ...
    private OnKeyboardActionListener mOnKeyboardActionListener = new OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            if (focusCurrent == null || (focusCurrent.getClass() != EditText.class && focusCurrent.getClass().getSuperclass() != EditText.class)) {
                return;
            }
            ...
            else if (primaryCode == CodeCellUp
                  || primaryCode == CodeCellDown
                  || primaryCode == CodeCellLeft
