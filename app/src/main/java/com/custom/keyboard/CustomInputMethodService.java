...
public class CustomInputMethodService extends InputMethodService implements KeyboardView.OnKeyboardActionListener, SpellCheckerSession.SpellCheckerSessionListener {
    ...
    public void populate() {
        ...
        if (sharedPreferences.getBoolean("cherokee",        true)) {layouts.add(new CustomKeyboard(this, R.layout.cherokee,    "cherokee",    "Cherokee",   "ꭰꭱꭲꭳꭴꭵ"));}
        ...
        switch (primaryCode) {
            ...
            case -136:
                if (!isSelecting()) {
                    ...
                    // performReplace(getText(ic).trim());
                }
                else {
