...
public class Edit {
    ...
    private static void makeReplacements() {
        ...
        replacements.put("^i", "I"); replacements.put(" i", " I");
        ...
        replacements.put("^hed", "he'd"); replacements.put(" hed", " he'd");
        replacements.put("^hes", "he's"); replacements.put(" hes", " he's");
        replacements.put("^hows", "how's"); replacements.put(" hows", " how's");
        replacements.put("^im", " I'm"); replacements.put(" im", " I'm");
        replacements.put("^ive", "I've"); replacements.put(" ive", " I've");
        replacements.put("^shes", "she's"); replacements.put(" shes", " she's");
        ...
        replacements.put("^itd", "it'd"); replacements.put(" itd", " it'd");
        replacements.put("^itll", "it'll"); replacements.put(" itll", " it'll");
        ...
        replacements.put("^someones", "someone's"); replacements.put(" someones", " someone's");
        replacements.put(" somethings", " something's");
        replacements.put("^thatll", "that'll"); replacements.put(" thatll", " that'll");
        replacements.put(" thatre", " that're");
        replacements.put("^thats", "that's"); replacements.put(" thats", " that's");
        ...
        replacements.put("^theres", "there's"); replacements.put(" theres", " there's");
        replacements.put(" thesere", " these're");
        replacements.put("^theyd", "they'd"); replacements.put(" theyd", " they'd");
        replacements.put("^theyll", "they'll"); replacements.put(" theyll", " they'll");
        replacements.put("^theyre", "they're"); replacements.put(" theyre", " they're");
        replacements.put("^theyve", "they've"); replacements.put(" theyve", " they've");
        ...
        replacements.put("^whats", "what's"); replacements.put(" whats", " what's");
        replacements.put(" whatve", " what've");
        replacements.put(" whens", " when's");
        replacements.put("^whered", "where'd"); replacements.put(" whered", " where'd");
        replacements.put("^wheres", "where's"); replacements.put(" wheres", " where's");
        replacements.put(" whod", " who'd");
        replacements.put(" whodve", " who'd've");
        replacements.put(" wholl", " who'll");
        replacements.put("^whos", "who's"); replacements.put(" whos", " who's");
        replacements.put(" whove", " who've");
        replacements.put("^whyd", "why'd"); replacements.put(" whyd", " why'd");
        replacements.put(" whyre", " why're");
        replacements.put("^whys", "why's"); replacements.put(" whys", " why's");
        replacements.put(" wont", " won't");
        replacements.put(" wouldve", " would've");
        replacements.put(" wouldnt", " wouldn't");
        replacements.put(" yall", " y'all");
        replacements.put("^youd", "you'd"); replacements.put(" youd", " you'd");
        replacements.put("^youll", "you'll"); replacements.put(" youll", " you'll");
        replacements.put("^youre", "you're"); replacements.put(" youre", " you're");
        replacements.put("^youve", "you've"); replacements.put(" youve", " you've");
