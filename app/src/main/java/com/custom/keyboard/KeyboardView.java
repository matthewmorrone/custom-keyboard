...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public static final int[] KEY_DELETE = {Keyboard.KEYCODE_DELETE};
    public static final int[] LONG_PRESSABLE_STATE_SET = {R.attr.state_long_pressable};

    public com.custom.keyboard.Keyboard mKeyboard;
    public int mCurrentKeyIndex = NOT_A_KEY;
    ...
    public Map<Key, View> mMiniKeyboardCache;
    public Key[] mKeys;
    ...
    public SwipeTracker mSwipeTracker = new SwipeTracker();
    ...
    public static final int REPEAT_INTERVAL = 50; // ~20 keys per second
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        a = this.getContext().obtainStyledAttributes(R.styleable.Theme);
        ...
        // AccessibilityManager mAccessibilityManager = AccessibilityManager.getInstance(context);
     ...
     * @see #getKeyboard()
     */
    public void setKeyboard(com.custom.keyboard.Keyboard keyboard) {
        if (mKeyboard != null) {
        ...
        removeMessages();
        mKeyboard = keyboard;
        List<com.custom.keyboard.Keyboard.Key> keys = mKeyboard.getKeys();
     ...
     */
    public com.custom.keyboard.Keyboard getKeyboard() {
        return mKeyboard;
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // Round up a little
        if (mKeyboard == null) {
            setMeasuredDimension(this.getPaddingLeft() + this.getPaddingRight(), this.getPaddingTop() + this.getPaddingBottom());
        }
        else {
            int width = mKeyboard.getMinWidth() + this.getPaddingLeft() + this.getPaddingRight();
            if (MeasureSpec.getSize(widthMeasureSpec) < width + 10) {
                width = MeasureSpec.getSize(widthMeasureSpec);
            }
            setMeasuredDimension(width, mKeyboard.getHeight() + this.getPaddingTop() + this.getPaddingBottom());
        }
    }
     ...
     * @param keyboard
     */
    private void computeProximityThreshold(com.custom.keyboard.Keyboard keyboard) {
        if (keyboard == null) {
            return;
        }
    ...
    private void onBufferDraw() {
        ...
        final int kbdPaddingLeft = this.getPaddingLeft();
        final int kbdPaddingTop = this.getPaddingTop();
        final Key[] keys = mKeys;
    ...
    public void showKey(final int keyIndex) {
        final PopupWindow previewPopup = mPreviewPopup;
        final Key[] keys = mKeys;
        ...
        if (!mPreviewCentered) {
            mPopupPreviewX = key.x - mPreviewText.getPaddingLeft() + this.getPaddingLeft();
    ...
    public void sendAccessibilityEventForUnicodeCharacter(int eventType, int code) {
        if (mAccessibilityManager.isEnabled()) {
            ...
            switch (code) {
                case Keyboard.KEYCODE_ALT:
                    text = this.getContext().getString(R.string.keyboardview_keycode_alt);
                break;
                case Keyboard.KEYCODE_CANCEL:
                    text = this.getContext().getString(R.string.keyboardview_keycode_cancel);
                break;
                case Keyboard.KEYCODE_DELETE:
                    text = this.getContext().getString(R.string.keyboardview_keycode_delete);
                break;
                case Keyboard.KEYCODE_DONE:
                    text = this.getContext().getString(R.string.keyboardview_keycode_done);
                break;
                case Keyboard.KEYCODE_MODE_CHANGE:
                    text = this.getContext().getString(R.string.keyboardview_keycode_mode_change);
                break;
                case Keyboard.KEYCODE_SHIFT:
                    text = this.getContext().getString(R.string.keyboardview_keycode_shift);
                break;
                case '\n':
                    text = this.getContext().getString(R.string.keyboardview_keycode_enter);
                break;
                default:
    ...
    public void invalidateKey(int keyIndex) {
        ...
        mInvalidatedKey = key;
        mDirtyRect.union(key.x + this.getPaddingLeft(), key.y + this.getPaddingTop(), key.x + key.width + this.getPaddingLeft(), key.y + key.height + this.getPaddingTop());
        onBufferDraw();
        invalidate(key.x + this.getPaddingLeft(), key.y + this.getPaddingTop(), key.x + key.width + this.getPaddingLeft(), key.y + key.height + this.getPaddingTop());
    }
    ...
    public boolean onLongPress(Key popupKey) {
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                com.custom.keyboard.Keyboard keyboard;
                if (popupKey.popupCharacters != null) {
                    keyboard = new com.custom.keyboard.Keyboard(getContext(), popupKeyboardId, popupKey.popupCharacters, -1, getPaddingLeft() + getPaddingRight());
                }
                else {
                    keyboard = new com.custom.keyboard.Keyboard(getContext(), popupKeyboardId);
                }
            ...
            getLocationInWindow(mCoordinates);
            mPopupX = popupKey.x + this.getPaddingLeft();
            mPopupY = popupKey.y + this.getPaddingTop();
    ...
    public boolean onModifiedTouchEvent(MotionEvent me, boolean possiblePoly) {
        int touchX = (int)me.getX() - this.getPaddingLeft();
        int touchY = (int)me.getY() - this.getPaddingTop();
