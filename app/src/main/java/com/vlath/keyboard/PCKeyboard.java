...
public class PCKeyboard extends InputMethodService implements KeyboardView.OnKeyboardActionListener, SpellCheckerSession.SpellCheckerSessionListener {
  ...
  public boolean isGreek(int primaryCode) {
    if (primaryCode >= 913 && primaryCode <= 937) {
      return true;
    }
    return false;
  }
  ...
  public void onKey(int primaryCode, int[] keyCodes) {
    ...
    switch (primaryCode) {
      ...
      case -7:
        ...
        break;
      case -8:
        ic.setSelection(0, ((String)ic.getExtractedText(new ExtractedTextRequest(), 0).text).length());
        break;
      case -9:
